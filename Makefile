...
install_upload_remotes: ## Install the remotes
	@echo "Installing remotes from packages/remotes_upload.json"
	conan config install -t file packages/remotes_upload.json
