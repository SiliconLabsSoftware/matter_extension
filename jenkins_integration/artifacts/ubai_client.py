...
def upload_to_ubai(file_path, app_name, target, branch_name, run_number, stack="matter"):
    """
    ...
    """
    print(f"Uploading {file_path} to UBAI.")
    try:
        subprocess.run([
            'ubai_upload_cli',
            ...
            '--metadata', 'build_number', str(run_number),
...
def search_file_in_ubai(branch_name, run_number, sqa):
    """
    ...
    print(f"Searching for {build_binaries} in UBAI.")
