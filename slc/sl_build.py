...
subprocess.run([slc_path, "--java-location", java_path, "generate", "-d", output_dir, "-p", silabs_app_path, "--with", silabs_board+config_args, "--force", "--generator-timeout=180", "-o", "makefile"])
