        ...
        with open(file_path, 'r') as file:
            for line in file:
                if file_path.endswith('.slce'):
                    ...
                    return True
                # Temporary checks for other package id's prior to PR fix to standardize package: matter
                elif 'package: Matter' in line:
                    return True
                elif 'package: "Matter"' in line:
                    return True
                elif 'package: platform' in line:
                    return True
                elif 'package: wiseconnect' in line:
                    return True
                # End temprorary checks, can remove after merged PR
        return False
