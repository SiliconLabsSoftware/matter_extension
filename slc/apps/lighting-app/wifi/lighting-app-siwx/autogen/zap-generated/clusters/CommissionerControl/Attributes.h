...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::SupportedDeviceCategories::TypeInfo::DecodableType supportedDeviceCategories     = static_cast<chip::BitMask<chip::app::Clusters::CommissionerControl::SupportedDeviceCategoryBitmap>>(0);
