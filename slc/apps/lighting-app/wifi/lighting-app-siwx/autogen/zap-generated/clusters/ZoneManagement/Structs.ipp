...
if (__context_tag == to_underlying(Fields::kY))
        {
...
if (__context_tag == to_underlying(Fields::kUse))
        {
          err = DataModel::Decode(reader, use);
        }
        else
if (__context_tag == to_underlying(Fields::kVertices))
        {
...
if (__context_tag == to_underlying(Fields::kZoneType))
        {
          err = DataModel::Decode(reader, zoneType);
        }
        else
if (__context_tag == to_underlying(Fields::kZoneSource))
        {
          err = DataModel::Decode(reader, zoneSource);
        }
        else
if (__context_tag == to_underlying(Fields::kTwoDCartesianZone))
        {
