...
namespace ThreadNetworks {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::DecodableList<chip::app::Clusters::ThreadNetworkDirectory::Structs::ThreadNetworkStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::DecodableList<chip::app::Clusters::ThreadNetworkDirectory::Structs::ThreadNetworkStruct::DecodableType> &;
