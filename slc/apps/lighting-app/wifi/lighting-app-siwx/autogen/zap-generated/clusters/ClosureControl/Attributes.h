...
namespace OverallCurrentState {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::Nullable<chip::app::Clusters::ClosureControl::Structs::OverallCurrentStateStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::ClosureControl::Structs::OverallCurrentStateStruct::DecodableType> &;
...
namespace OverallTargetState {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::Nullable<chip::app::Clusters::ClosureControl::Structs::OverallTargetStateStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::ClosureControl::Structs::OverallTargetStateStruct::DecodableType> &;
...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::MainState::TypeInfo::DecodableType mainState     = static_cast<chip::app::Clusters::ClosureControl::MainStateEnum>(0);
        ...
        Attributes::LatchControlModes::TypeInfo::DecodableType latchControlModes     = static_cast<chip::BitMask<chip::app::Clusters::ClosureControl::LatchControlModesBitmap>>(0);
