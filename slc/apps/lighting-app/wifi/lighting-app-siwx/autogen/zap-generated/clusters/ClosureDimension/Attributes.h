...
namespace CurrentState {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::Nullable<chip::app::Clusters::ClosureDimension::Structs::DimensionStateStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::ClosureDimension::Structs::DimensionStateStruct::DecodableType> &;
...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::LatchControlModes::TypeInfo::DecodableType latchControlModes     = static_cast<chip::BitMask<chip::app::Clusters::ClosureDimension::LatchControlModesBitmap>>(0);
