...
if (__context_tag == to_underlying(Fields::kVIDVerificationStatement))
        {
            err = DataModel::Decode(reader, VIDVerificationStatement);}
        else
if (__context_tag == to_underlying(Fields::kVvsc))
        {
...
if (__context_tag == to_underlying(Fields::kClientChallenge))
        {
...
if (__context_tag == to_underlying(Fields::kFabricBindingVersion))
        {
            err = DataModel::Decode(reader, fabricBindingVersion);}
        else
if (__context_tag == to_underlying(Fields::kSignature))
        {
