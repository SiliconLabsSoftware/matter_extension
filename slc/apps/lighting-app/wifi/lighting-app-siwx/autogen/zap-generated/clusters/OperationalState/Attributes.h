...
namespace OperationalStateList {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::DecodableList<chip::app::Clusters::OperationalState::Structs::OperationalStateStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::DecodableList<chip::app::Clusters::OperationalState::Structs::OperationalStateStruct::DecodableType> &;
...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::OperationalState::TypeInfo::DecodableType operationalState     = static_cast<chip::app::Clusters::OperationalState::OperationalStateEnum>(0);
