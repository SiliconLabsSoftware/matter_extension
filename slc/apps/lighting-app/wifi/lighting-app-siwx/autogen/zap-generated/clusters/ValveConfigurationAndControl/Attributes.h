...
namespace CurrentState {
      struct TypeInfo {
          ...
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::ValveConfigurationAndControl::ValveStateEnum> &;
...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::ValveFault::TypeInfo::DecodableType valveFault     = static_cast<chip::BitMask<chip::app::Clusters::ValveConfigurationAndControl::ValveFaultBitmap>>(0);
