...
if (__context_tag == to_underlying(Fields::kTilt))
        {
            err = DataModel::Decode(reader, tilt);}
        else
if (__context_tag == to_underlying(Fields::kZoom))
        {
...
if (__context_tag == to_underlying(Fields::kTiltDelta))
        {
            err = DataModel::Decode(reader, tiltDelta);}
        else
if (__context_tag == to_underlying(Fields::kZoomDelta))
        {
...
if (__context_tag == to_underlying(Fields::kDeltaX))
        {
            err = DataModel::Decode(reader, deltaX);}
        else
if (__context_tag == to_underlying(Fields::kDeltaY))
        {
