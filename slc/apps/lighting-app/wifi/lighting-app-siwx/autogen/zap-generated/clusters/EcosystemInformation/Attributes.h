...
namespace DeviceDirectory {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::DecodableList<chip::app::Clusters::EcosystemInformation::Structs::EcosystemDeviceStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::DecodableList<chip::app::Clusters::EcosystemInformation::Structs::EcosystemDeviceStruct::DecodableType> &;
...
namespace LocationDirectory {
      struct TypeInfo {
          using Type = chip::app::DataModel::List<const chip::app::Clusters::EcosystemInformation::Structs::EcosystemLocationStruct::Type>;
          using DecodableType = chip::app::DataModel::DecodableList<chip::app::Clusters::EcosystemInformation::Structs::EcosystemLocationStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::DecodableList<chip::app::Clusters::EcosystemInformation::Structs::EcosystemLocationStruct::DecodableType> &;
