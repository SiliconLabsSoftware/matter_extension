...
namespace SupportedRinses {
      struct TypeInfo {
          ...
          using DecodableArgType = const chip::app::DataModel::DecodableList<chip::app::Clusters::LaundryWasherControls::NumberOfRinsesEnum> &;
...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::NumberOfRinses::TypeInfo::DecodableType numberOfRinses     = static_cast<chip::app::Clusters::LaundryWasherControls::NumberOfRinsesEnum>(0);
