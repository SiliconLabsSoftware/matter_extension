...
if (__context_tag == to_underlying(Fields::kPeriodEnd))
        {
          err = DataModel::Decode(reader, periodEnd);
        }
        else
if (__context_tag == to_underlying(Fields::kGridCarbonIntensity))
        {
          err = DataModel::Decode(reader, gridCarbonIntensity);
        }
        else
if (__context_tag == to_underlying(Fields::kGridCarbonLevel))
        {
          err = DataModel::Decode(reader, gridCarbonLevel);
        }
        else
if (__context_tag == to_underlying(Fields::kLocalCarbonIntensity))
        {
          err = DataModel::Decode(reader, localCarbonIntensity);
        }
        else
if (__context_tag == to_underlying(Fields::kLocalCarbonLevel))
        {
