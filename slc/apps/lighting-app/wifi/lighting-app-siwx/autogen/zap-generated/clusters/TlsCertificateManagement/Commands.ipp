...
if (__context_tag == to_underlying(Fields::kNonceSignature))
        {
...
if (__context_tag == to_underlying(Fields::kClientCertificate))
        {
            err = DataModel::Decode(reader, clientCertificate);}
        else
if (__context_tag == to_underlying(Fields::kIntermediateCertificates))
        {
