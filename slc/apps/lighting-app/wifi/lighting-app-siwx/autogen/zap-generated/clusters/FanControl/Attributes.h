...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::FanModeSequence::TypeInfo::DecodableType fanModeSequence     = static_cast<chip::app::Clusters::FanControl::FanModeSequenceEnum>(0);
        ...
        Attributes::RockSupport::TypeInfo::DecodableType rockSupport     = static_cast<chip::BitMask<chip::app::Clusters::FanControl::RockBitmap>>(0);
        Attributes::RockSetting::TypeInfo::DecodableType rockSetting     = static_cast<chip::BitMask<chip::app::Clusters::FanControl::RockBitmap>>(0);
        Attributes::WindSupport::TypeInfo::DecodableType windSupport     = static_cast<chip::BitMask<chip::app::Clusters::FanControl::WindBitmap>>(0);
        Attributes::WindSetting::TypeInfo::DecodableType windSetting     = static_cast<chip::BitMask<chip::app::Clusters::FanControl::WindBitmap>>(0);
        Attributes::AirflowDirection::TypeInfo::DecodableType airflowDirection     = static_cast<chip::app::Clusters::FanControl::AirflowDirectionEnum>(0);
