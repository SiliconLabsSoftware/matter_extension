...
if (__context_tag == to_underlying(Fields::kSegmentDuration))
        {
...
if (__context_tag == to_underlying(Fields::kSessionGroup))
        {
          err = DataModel::Decode(reader, sessionGroup);
        }
        else
if (__context_tag == to_underlying(Fields::kTrackName))
        {
...
if (__context_tag == to_underlying(Fields::kTLSEndpointID))
        {
