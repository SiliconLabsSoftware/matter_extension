...
if (__context_tag == to_underlying(Fields::kCurrentSystemMode))
        {
...
if (__context_tag == to_underlying(Fields::kCurrentOccupancy))
        {
...
if (__context_tag == to_underlying(Fields::kPreviousSetpoint))
        {
            err = DataModel::Decode(reader, previousSetpoint);
        }
        else
if (__context_tag == to_underlying(Fields::kCurrentSetpoint))
        {
...
if (__context_tag == to_underlying(Fields::kCurrentRunningState))
        {
...
if (__context_tag == to_underlying(Fields::kCurrentRunningMode))
        {
...
if (__context_tag == to_underlying(Fields::kCurrentScheduleHandle))
        {
...
if (__context_tag == to_underlying(Fields::kCurrentPresetHandle))
        {
