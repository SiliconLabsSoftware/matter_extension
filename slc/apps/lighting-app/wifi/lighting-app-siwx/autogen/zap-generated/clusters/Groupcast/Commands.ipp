...
if (__context_tag == to_underlying(Fields::kKeyID))
        {
...
if (__context_tag == to_underlying(Fields::kGracePeriod))
        {
            err = DataModel::Decode(reader, gracePeriod);}
        else
if (__context_tag == to_underlying(Fields::kUseAuxiliaryACL))
        {
...
if (__context_tag == to_underlying(Fields::kListTooLarge))
        {
