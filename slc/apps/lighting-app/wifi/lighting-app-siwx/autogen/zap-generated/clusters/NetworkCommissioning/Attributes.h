...
namespace Networks {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::DecodableList<chip::app::Clusters::NetworkCommissioning::Structs::NetworkInfoStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::DecodableList<chip::app::Clusters::NetworkCommissioning::Structs::NetworkInfoStruct::DecodableType> &;
...
namespace LastNetworkingStatus {
      struct TypeInfo {
          ...
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::NetworkCommissioning::NetworkCommissioningStatusEnum> &;
...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::SupportedThreadFeatures::TypeInfo::DecodableType supportedThreadFeatures     = static_cast<chip::BitMask<chip::app::Clusters::NetworkCommissioning::ThreadCapabilitiesBitmap>>(0);
