...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::HeaterTypes::TypeInfo::DecodableType heaterTypes     = static_cast<chip::BitMask<chip::app::Clusters::WaterHeaterManagement::WaterHeaterHeatSourceBitmap>>(0);
        Attributes::HeatDemand::TypeInfo::DecodableType heatDemand     = static_cast<chip::BitMask<chip::app::Clusters::WaterHeaterManagement::WaterHeaterHeatSourceBitmap>>(0);
        ...
        Attributes::BoostState::TypeInfo::DecodableType boostState     = static_cast<chip::app::Clusters::WaterHeaterManagement::BoostStateEnum>(0);
