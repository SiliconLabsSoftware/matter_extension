...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::DriftCompensation::TypeInfo::DecodableType driftCompensation     = static_cast<chip::app::Clusters::ColorControl::DriftCompensationEnum>(0);
        ...
        Attributes::Options::TypeInfo::DecodableType options     = static_cast<chip::BitMask<chip::app::Clusters::ColorControl::OptionsBitmap>>(0);
        ...
        Attributes::EnhancedColorMode::TypeInfo::DecodableType enhancedColorMode     = static_cast<chip::app::Clusters::ColorControl::EnhancedColorModeEnum>(0);
        ...
        Attributes::ColorCapabilities::TypeInfo::DecodableType colorCapabilities     = static_cast<chip::BitMask<chip::app::Clusters::ColorControl::ColorCapabilitiesBitmap>>(0);
        ...
        Attributes::CoupleColorTempToLevelMinMireds::TypeInfo::DecodableType coupleColorTempToLevelMinMireds     = static_cast<uint16_t>(0);
