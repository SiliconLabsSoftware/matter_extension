...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::MovementState::TypeInfo::DecodableType movementState     = static_cast<chip::app::Clusters::CameraAvSettingsUserLevelManagement::PhysicalMovementEnum>(0);
