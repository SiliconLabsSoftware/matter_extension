...
namespace TariffInfo {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::Nullable<chip::app::Clusters::CommodityTariff::Structs::TariffInformationStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::CommodityTariff::Structs::TariffInformationStruct::DecodableType> &;
...
namespace DayEntries {
      struct TypeInfo {
          using Type = chip::app::DataModel::Nullable<chip::app::DataModel::List<const chip::app::Clusters::CommodityTariff::Structs::DayEntryStruct::Type>>;
          using DecodableType = chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::DayEntryStruct::DecodableType>>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::DayEntryStruct::DecodableType>> &;
...
namespace DayPatterns {
      struct TypeInfo {
          using Type = chip::app::DataModel::Nullable<chip::app::DataModel::List<const chip::app::Clusters::CommodityTariff::Structs::DayPatternStruct::Type>>;
          using DecodableType = chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::DayPatternStruct::DecodableType>>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::DayPatternStruct::DecodableType>> &;
...
namespace CalendarPeriods {
      struct TypeInfo {
          using Type = chip::app::DataModel::Nullable<chip::app::DataModel::List<const chip::app::Clusters::CommodityTariff::Structs::CalendarPeriodStruct::Type>>;
          using DecodableType = chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::CalendarPeriodStruct::DecodableType>>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::CalendarPeriodStruct::DecodableType>> &;
...
namespace IndividualDays {
      struct TypeInfo {
          using Type = chip::app::DataModel::Nullable<chip::app::DataModel::List<const chip::app::Clusters::CommodityTariff::Structs::DayStruct::Type>>;
          using DecodableType = chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::DayStruct::DecodableType>>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::DayStruct::DecodableType>> &;
...
namespace CurrentDay {
      struct TypeInfo {
          ...
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::CommodityTariff::Structs::DayStruct::DecodableType> &;
...
namespace CurrentDayEntry {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::Nullable<chip::app::Clusters::CommodityTariff::Structs::DayEntryStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::CommodityTariff::Structs::DayEntryStruct::DecodableType> &;
...
namespace TariffComponents {
      struct TypeInfo {
          using Type = chip::app::DataModel::Nullable<chip::app::DataModel::List<const chip::app::Clusters::CommodityTariff::Structs::TariffComponentStruct::Type>>;
          using DecodableType = chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::TariffComponentStruct::DecodableType>>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::TariffComponentStruct::DecodableType>> &;
...
namespace TariffPeriods {
      struct TypeInfo {
          using Type = chip::app::DataModel::Nullable<chip::app::DataModel::List<const chip::app::Clusters::CommodityTariff::Structs::TariffPeriodStruct::Type>>;
          using DecodableType = chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::TariffPeriodStruct::DecodableType>>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::DataModel::DecodableList<chip::app::Clusters::CommodityTariff::Structs::TariffPeriodStruct::DecodableType>> &;
...
namespace DefaultRandomizationType {
      struct TypeInfo {
          ...
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::CommodityTariff::DayEntryRandomizationTypeEnum> &;
