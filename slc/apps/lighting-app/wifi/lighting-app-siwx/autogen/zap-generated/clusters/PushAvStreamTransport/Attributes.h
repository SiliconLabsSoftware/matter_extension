...
namespace SupportedFormats {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::DecodableList<chip::app::Clusters::PushAvStreamTransport::Structs::SupportedFormatStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::DecodableList<chip::app::Clusters::PushAvStreamTransport::Structs::SupportedFormatStruct::DecodableType> &;
...
namespace CurrentConnections {
      struct TypeInfo {
          using Type = chip::app::DataModel::List<const chip::app::Clusters::PushAvStreamTransport::Structs::TransportConfigurationStruct::Type>;
          using DecodableType = chip::app::DataModel::DecodableList<chip::app::Clusters::PushAvStreamTransport::Structs::TransportConfigurationStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::DecodableList<chip::app::Clusters::PushAvStreamTransport::Structs::TransportConfigurationStruct::DecodableType> &;
