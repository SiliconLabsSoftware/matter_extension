...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::BallastStatus::TypeInfo::DecodableType ballastStatus     = static_cast<chip::BitMask<chip::app::Clusters::BallastConfiguration::BallastStatusBitmap>>(0);
        ...
        Attributes::LampAlarmMode::TypeInfo::DecodableType lampAlarmMode     = static_cast<chip::BitMask<chip::app::Clusters::BallastConfiguration::LampAlarmModeBitmap>>(0);
