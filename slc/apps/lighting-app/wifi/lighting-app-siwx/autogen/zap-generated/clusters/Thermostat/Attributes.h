...
namespace ThermostatSuggestions {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::DecodableList<chip::app::Clusters::Thermostat::Structs::ThermostatSuggestionStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::DecodableList<chip::app::Clusters::Thermostat::Structs::ThermostatSuggestionStruct::DecodableType> &;
...
namespace CurrentThermostatSuggestion {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::Nullable<chip::app::Clusters::Thermostat::Structs::ThermostatSuggestionStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::Thermostat::Structs::ThermostatSuggestionStruct::DecodableType> &;
...
namespace ThermostatSuggestionNotFollowingReason {
      struct TypeInfo {
          using Type = chip::app::DataModel::Nullable<chip::BitMask<chip::app::Clusters::Thermostat::ThermostatSuggestionNotFollowingReasonBitmap>>;
          using DecodableType = chip::app::DataModel::Nullable<chip::BitMask<chip::app::Clusters::Thermostat::ThermostatSuggestionNotFollowingReasonBitmap>>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::BitMask<chip::app::Clusters::Thermostat::ThermostatSuggestionNotFollowingReasonBitmap>> &;
