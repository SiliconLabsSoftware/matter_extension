...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0xFFFFFFFF), 0x00000003, 4, ZAP_TYPE(INT32U), ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* WiredAssessedInputVoltage */  \
  { ZAP_SIMPLE_DEFAULT(0xFFFF), 0x00000004, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* WiredAssessedInputFrequency */  \
  { ZAP_SIMPLE_DEFAULT(1), 0x00000005, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(READABLE) }, /* WiredCurrentType */  \
  { ZAP_SIMPLE_DEFAULT(0xFFFFFFFF), 0x00000006, 4, ZAP_TYPE(INT32U), ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* WiredAssessedCurrent */  \
