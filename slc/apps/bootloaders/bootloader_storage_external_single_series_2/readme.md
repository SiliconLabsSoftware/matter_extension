...
For a full list of hardware requirements, see [Matter Hardware Requirements](https://docs.silabs.com/matter/2.10.0/matter-overview/#hardware-requirements) documentation. This bootloader requires a board with external SPI flash of at least 1 MB.
...
2. Flash the bootloader to the device before flashing the application. Pre-built bootloader binaries for supported devices are available at [Matter Bootloader Binaries](https://docs.silabs.com/matter/2.10.0/matter-prerequisites/matter-artifacts#matter-bootloader-binaries).
...
- [Matter Bootloader Binaries](https://docs.silabs.com/matter/2.10.0/matter-prerequisites/matter-artifacts#matter-bootloader-binaries)
- [Matter Prerequisites](https://docs.silabs.com/matter/2.10.0/matter-prerequisites)
