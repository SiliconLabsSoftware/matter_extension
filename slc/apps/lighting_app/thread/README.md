...
The EFR32 lighting app provides a baseline implementation of a light control device built using Matter and Simplicity SDK. It can be controlled by a Matter controller over an Openthread network.
