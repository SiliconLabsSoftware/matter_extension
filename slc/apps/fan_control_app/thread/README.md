...
The Matter over Thread fan control example is a baseline demonstration of a fan device built with Simplicity SDK. It can be controlled by a Matter controller over an OpenThread network.
