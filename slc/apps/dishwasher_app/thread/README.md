...
The Matter over Thread dishwasher example is a baseline demonstration of a dishwasher built with Simplicity SDK. It can be controlled by a Matter controller over an OpenThread network.
