...
The Matter over Thread rangehood example is a baseline demonstration of a rangehood built with Simplicity SDK. It can be controlled by a Matter controller over an OpenThread network.
