...
The Matter over Thread lock example is a baseline demonstration of a lock device built with Simplicity SDK. It can be controlled by a Matter controller over an OpenThread network.
