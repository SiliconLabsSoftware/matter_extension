...
The Matter over Thread OnOff Plug example is a baseline demonstration of an OnOff Plug built with Simplicity SDK. It can be controlled by a Matter controller over an OpenThread network.
