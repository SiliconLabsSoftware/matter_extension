...
The Matter over Thread thermostat example is a baseline demonstration of a thermostat built with Simplicity SDK. It can be controlled by a Matter controller over an OpenThread network.
