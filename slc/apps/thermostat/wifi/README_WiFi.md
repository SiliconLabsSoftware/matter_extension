...
For general information on running Matter applications and prerequisites, see the [Matter Wi-Fi documentation](https://docs.silabs.com/matter/2.10.0/matter-wifi) on docs.silabs.com.
...
This sample app works out of the box with no additional configuration required. To customize the device, see the [Custom Matter Device Development](https://docs.silabs.com/matter/2.10.0/matter-references/custom-matter-device#custom-matter-device-development) guide.
...
3. Commission the device using one of the following methods:
   ...
   **chip-tool (standalone or pre-built):** The pre-built chip-tool instance ships
   ...
   [Silicon Labs Matter Hub Documentation](https://docs.silabs.com/matter/2.10.0/matter-thread/raspi-img).
   ```shell
...
- [Silicon Labs Matter over Wi-Fi Documentation](https://docs.silabs.com/matter/2.10.0/matter-wifi)
